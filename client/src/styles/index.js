const styles = {
  ...
  infoText: 'font-rajdhani font-medium text-lg text-green-500 cursor-pointer',
  ...
  hocContentBox: 'flex flex-1 justify-between bg-gray-800 py-8 sm:px-12 px-8 flex-col',
  ...
  btn: 'px-4 py-2 rounded-lg bg-green-500 w-fit text-white font-rajdhani font-bold',

  // custom input component
  label: 'font-rajdhani font-semibold text-2xl text-white mb-3',
  input: 'bg-siteDimBlack text-white outline-none focus:outline-green-500 p-4 rounded-md sm:max-w-[50%] max-w-full',
  ...
  gameLoadVS: 'font-rajdhani font-extrabold text-green-500 text-7xl mx-16',

  // gameInfo component
  gameInfoIconBox: 'absolute right-2 top-1/2',
  gameInfoIcon: 'bg-green-500 w-10 h-10 rounded-md cursor-pointer',
  ...
  gameInfoSidebarClose: 'w-10 h-10 rounded-md bg-green-500 text-white font-rajdhani font-extrabold text-xl cursor-pointer',
